...
[ansible ELK staen](https://github.com/sam-l-112/ansible_elk_staen/tree/main)

# 應用
基礎ELK設施: Rocky Linux 10.x / k3s

日誌分析 (SIEM): ELK Stack (Elasticsearch, Logstash, Kibana)

端點監控: Filebeat, Metricbeat

基礎漏洞建設: ubuntu linux 24.04 LTS (server) / Docker

漏洞追蹤: Docker 部署之 Nginx, Apache, MariaDB , OpenCVE

[threat hunting lab ELK](https://github.com/sam-l-112/threat-hunting-lab-ELK)
